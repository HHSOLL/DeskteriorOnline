  ...
  if (isTopView) {
    ...
    if (topMode === "desk-precision") {
      return {
        ...
        enableBloom: true,
        bloomIntensity: constrainedDevice ? 0.12 : 0.22,
        vignetteDarkness: constrainedDevice ? 0.08 : 0.16,
        noiseOpacity: constrainedDevice ? 0.0015 : 0.003,
    ...
    return {
      ...
      enablePostEffects: true,
      enableBloom: true,
      bloomIntensity: constrainedDevice ? 0.1 : 0.18,
      vignetteDarkness: constrainedDevice ? 0.06 : 0.14,
      noiseOpacity: constrainedDevice ? 0.0015 : 0.0025,
      enableSsao: !constrainedDevice,
      enableSSR: false,
      ssrIntensity: 0,
      ssrMaxRoughness: 0,
